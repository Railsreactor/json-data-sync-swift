Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/Railsreactor/json-data-sync-swift.git", :tag => "0.1.2" }
  s.source_files  = "JDSKit", "JDSKit/**/*.{sh,h,m,swift}"  
  s.public_header_files = "JDSKit/**/*.h", "JDSKit/Local/Obj-C Bridge/SNExceptionWrapper.h"
